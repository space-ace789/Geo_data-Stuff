...
To test whether there is an effect of species 

```{r}
adfshjfahjkafkhj <- data.frame(lon = species2_combined_coords$lon, lat = species2_combined_coords$lat, species2_pa_data)
```
